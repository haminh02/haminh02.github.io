...
document.querySelector('.time-start1').innerHTML = `${dataTime} ${date.toLocaleTimeString()} UTC+7<br>(${date.getTime()})`;
...
document.querySelector('.time-start2').innerHTML = `${dataTime} ${date.toLocaleTimeString()} UTC+7<br>(${date.getTime()})`;

date.setHours(22);
document.querySelector('.time-finish2').innerHTML = `${dataTime} ${date.toLocaleTimeString()} UTC+7<br>(${date.getTime()})`;